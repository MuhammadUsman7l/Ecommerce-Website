...
const ProductCard = ({ image, brandname, name, price }) => {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 flex flex-col justify-between">
      ...
      <div className="p-4 flex flex-col h-full justify-between">
        ...
        <div className="mt-auto">
          <p className="text-orange-700 text-xl font-semibold mb-4">
            Deal Price = ${price}
          </p>
        </div>
        ...
        <div className="w-full">
          <button className="bg-orange-700 text-white px-4 py-2 rounded-md hover:bg-white hover:text-orange-700 hover:border-2 hover:border-orange-700 transition flex items-center justify-center">
